about_section = """
## About Auto Code Review

This project is designed to help software developers improve
...
allowing them to discover potential issues and vulnerability  in their codebase.

To use Auto Code Review to analyze your code, follow these
steps:
...
Keep in mind that the Auto Code Review is an AI-powered tool, and while it can
